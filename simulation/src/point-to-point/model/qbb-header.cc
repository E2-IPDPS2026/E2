...
namespace ns3 {
	...
	qbbHeader::qbbHeader(uint16_t pg)
		//: m_pg(pg), sport(0), dport(0), flags(0), m_seq(0), newTag(0), m_rate(0)
	...
	qbbHeader::qbbHeader()
		//: m_pg(0), sport(0), dport(0), flags(0), m_seq(0), newTag(0), m_rate(0)
	...
	uint32_t qbbHeader::GetBaseSize() {
		qbbHeader tmp;
		//return sizeof(tmp.sport) + sizeof(tmp.dport) + sizeof(tmp.flags) + sizeof(tmp.m_pg) + sizeof(tmp.m_seq) + sizeof(tmp.newTag) + sizeof(tmp.m_rate);
		//return sizeof(tmp.sport) + sizeof(tmp.dport) + sizeof(tmp.flags) + sizeof(tmp.m_pg) + sizeof(tmp.m_seq);
		return sizeof(tmp.sport) + sizeof(tmp.dport) + sizeof(tmp.flags) + sizeof(tmp.m_pg) + sizeof(tmp.m_seq);
		//return sizeof(tmp.sport) + sizeof(tmp.dport) + sizeof(tmp.flags) + sizeof(tmp.m_pg) + sizeof(tmp.m_seq) + sizeof(tmp.m_flows);
	}
