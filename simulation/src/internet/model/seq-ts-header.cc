...
void SeqTsHeader::SetCurRate(uint8_t rate)
{
  cur_rate = rate;
}
uint8_t SeqTsHeader::GetCurRate(void) const
{
  return cur_rate;
}
// void SeqTsHeader::SetIgnore(uint8_t ig)
// {
//   ignore = ig;
// }
// uint8_t SeqTsHeader::GetIgnore(void) const
// {
//   return ignore;
// }
...
uint32_t SeqTsHeader::GetHeaderSize(void){
	return 6 + 1 + IntHeader::GetStaticSize();
  //return 6 + 8 + 8 + IntHeader::GetStaticSize();
  //return 6 + 1 + 4 + IntHeader::GetStaticSize();
}
